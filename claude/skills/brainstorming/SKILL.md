...
5. **Write design doc** — save to `docs/plans/YYYY-MM-DD-<topic>-design.md` and
   commit
...
**Documentation:**
- Create a directory called `user_stories/yyyyMMdd-<user_story_slug>/`
- Write a PRD based on the conversation in `user_stories/yyyyMMdd-<user_story_slug>/`/PRD.md
- Write the validated design to `user_stories/yyyyMMdd-<user_story_slug>/`/plan.md
